...
public class EditPage extends FakeActivity implements OnClickListener, TextWatcher {
    ...
    private RelativeLayout getPageView() {
        ...
        if (dialogMode) {
            ...
            rlDialog.setBackgroundColor(0xFF606060);
            ...
            page.setBackgroundColor(0xFF606060);
            RelativeLayout.LayoutParams lpPage = new RelativeLayout.LayoutParams(
                    LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT);
            page.setLayoutParams(lpPage);
            rlPage.addView(page);

            page.addView(getPageTitle());
            page.addView(getPageBody());
            page.addView(getImagePin());
        }
        return rlPage;
    }
